...
from ass_flow.experimental.local_dask import (
    DelayedLowering,
...
assert 'ass_flow.experimental' not in sys.modules
import ass_flow.experimental
assert 'dask' not in sys.modules
assert 'ass_flow.experimental.local_dask' not in sys.modules
try:
    import ass_flow.experimental.local_dask
...
"""
    ...
    assert completed.stdout.strip() == (
        "ass_flow.experimental.local_dask requires the optional dependency "
        "'dask==2026.7.1'"
    )
