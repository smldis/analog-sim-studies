...
against `distributed==2026.7.1`, the version `ass-run[dask]` pins:
...
from ass_run.site import EXPOSURES, Site, SiteError
...
def local_cluster(
    *,
    ...
    One worker with many threads, for the reasons `ass_run.graph` sets out: an
